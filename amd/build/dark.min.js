define(["jquery","core/ajax"],function($,ajax){var darkmenu={init:function(){darkmenu.addmenu();var $layoutMode=$(".kraus-layout-dark div");$layoutMode.click(function(){$("body").addClass("dark-animation");setTimeout(function(){$("body").removeClass("dark-animation")},500);var layout="dark";if($("html").attr("data-bs-theme")=="dark"){layout="light"}$("html").attr("data-bs-theme",layout);ajax.call([{methodname:"local_boost_dark_userpreference_layout",args:{layout:layout}}])})},addmenu:function(){var darkmenu=`<div class="kraus-layout-dark">
                     ...
                     </div>`;$("#usernavigation").prepend(darkmenu)}};return darkmenu});