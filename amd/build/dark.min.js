define(["jquery","core/ajax"],function($,ajax){return{init:function(){console.log("aaaaaaa");$(".navbar .simplesearchform").before(`<div class="layout-mode">
