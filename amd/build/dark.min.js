define(["jquery","core/ajax"],function($,ajax){var darkmenu={init:function(){darkmenu.addmenu();var $layoutMode=$(".layout-mode div");$layoutMode.click(function(){$("body").addClass("dark-animation");setTimeout(function(){$("body").removeClass("dark-animation")},500);var layout="dark";if($("html").attr("data-bs-theme")=="dark"){layout="light"}$("html").attr("data-bs-theme",layout);ajax.call([{methodname:"local_boost_dark_userprerence_layout",args:{layout:layout}}])})},addmenu:function(){var darkmenu=`<div class="layout-mode">
